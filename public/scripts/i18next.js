    ...
    resources: {
        fr: {
            translation: {
                ...
                "algorithm-project-paragraph": {
                    "paragraph-part1":"Nous avons entrepris de démontrer la complexité des problèmes TSP et TSPTW, deux problèmes notoires en informatique. Pour aborder ces défis, nous avons employé un algorithme génétique, une méthode heuristique puissante qui utilise des techniques inspirées de la biologie, telles que la sélection, la mutation et le croisement, pour trouver des solutions approximatives à des problèmes d'optimisation complexes.",
                    "paragraph-part2":"Au cours de notre exploration, nous avons également découvert les algorithmes gloutons et le recuit simulé. Tandis que les algorithmes gloutons fournissent une solution rapide en prenant les meilleures décisions locales à chaque étape, le recuit simulé utilise une approche probabiliste pour échapper aux optima locaux. Les mutations, essentielles dans notre algorithme génétique, ont introduit des variations aléatoires dans notre population de solutions, ce qui a aidé à diversifier la recherche et à éviter de rester coincé dans des solutions suboptimales.",
                    "paragraph-part3":"À travers la génération et l'évolution de populations successives, notre algorithme s'est amélioré progressivement, convergeant vers une solution plus optimale pour les problèmes TSP et TSPTW.",
                },
                "school": "Parcours scolaire",
                "lycee": "Lycée",
                "lycee-description": "Bac mention bien avec mention européenne",
                "stage":"Stage chez Renault Tech / Qstomize",
                "stage-description":"Voir plus dans la section suivante",
                "alternance":"Alternance chez Enedis",
        ...
        us: {
            translation: {
                ...
                "algorithm-project-paragraph": {
                    "paragraph-part1": "We undertook to demonstrate the complexity of the TSP and TSPTW problems, two notable challenges in computer science. To address these challenges, we employed a genetic algorithm, a powerful heuristic method that uses techniques inspired by biology, such as selection, mutation, and crossover, to find approximate solutions to complex optimization problems.",
                    "paragraph-part2": "During our exploration, we also discovered greedy algorithms and simulated annealing. While greedy algorithms provide a quick solution by making the best local decisions at each step, simulated annealing uses a probabilistic approach to escape local optima. Mutations, crucial in our genetic algorithm, introduced random variations in our solution population, aiding in diversifying the search and avoiding getting stuck in suboptimal solutions.",
                    "paragraph-part3": "Through the generation and evolution of successive populations, our algorithm progressively improved, converging towards a more optimal solution for the TSP and TSPTW problems."
                },
                "school": "Educational background",
                "lycee":"High school",
                "lycee-description":"A-levels with European honours (more english classes)",
                "stage":"Internship at Qstomize / Renault Tech",
